...
@Autonomous(name="Calibrate", group="generated")
public class Calibrate extends LinearOpMode {
    ...
    private Integer cpr = 538; //counts per rotation
    private Integer gearratio = 20;
    private Double diameter = 3.937;
    private Double cpi = (cpr * gearratio) / (Math.PI * diameter); //counts per inch -> counts per rotation / circumference
    private Double bias = 0.8;//adjust until your robot goes 20 inches
    //
